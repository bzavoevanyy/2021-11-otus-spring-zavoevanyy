...
export class Genre extends Component {
    ...
    handleClick = (event) => {
        ...
        const chosenGenre = genres.find(genre => genre.genreId === parseInt(event.target.dataset.genreId))
        ...
        return (
            <div>
                            ...
                            <tr key={genre.genreId}>
                                ...
                                <td>
                                    <button name="edit" onClick={this.handleClick} type="button"
                                            ...
                                            data-bs-toggle="modal" data-genre-id={genre.genreId}
                                            data-bs-target="#editGenreModal">Edit
                                    </button>
                ...
                <DeleteModal
                    ...
                    entityId={this.state.chosenGenre.genreId}
                    onUpdate={this.onUpdateGenresList}/>
