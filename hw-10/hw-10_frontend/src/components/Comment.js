...
export class Comment extends Component {
    ...
    handleClick = (event) => {
        ...
        const chosenComment = comments.find(comment => comment.commentId === parseInt(event.target.dataset.commentId))
        ...
        return (
            <div>
                            ...
                            <tr key={comment.commentId}>
                                ...
                                <td>
                                    <button name="edit" onClick={this.handleClick} type="button"
                                            ...
                                            data-bs-toggle="modal" data-comment-id={comment.commentId}
                ...
                <DeleteCommentModal
                    ...
                    entityId={this.state.chosenComment.commentId}
                    onUpdate={this.onUpdateList}/>
            </div>
        )
    }
