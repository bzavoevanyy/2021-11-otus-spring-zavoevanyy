...
class BookControllerTest {
    ...
    @Test
    @DisplayName(" should redirect to login page when unauthorized for GET /book")
    void shouldRedirectToLoginPageWhenUnauthorizedForGetAll() throws Exception {
        mvc.perform(get("/book"))
    ...
    @Test
    @DisplayName(" should redirect to login page when unauthorized for GET /book/{id}")
    void shouldRedirectToLoginPageWhenUnauthorizedForGetOne() throws Exception {
        mvc.perform(get("/book/1"))
                .andExpect(status().is3xxRedirection());
    }
    ...
    @Test
    @DisplayName(" should redirect to login page when unauthorized for POST /book/{id}")
    void shouldRedirectToLoginPageWhenUnauthorizedForPostUpdate() throws Exception {
        val author = new Author(1L, "test author");
        val genre = new Genre(1L, "test genre");
        given(authorService.getAuthorById(1L)).willReturn(author);
        given(genreService.getGenreById(1L)).willReturn(genre);
    ...
    @Test
    @DisplayName(" should redirect to login page when unauthorized for POST /book")
    void shouldRedirectToLoginPageWhenUnauthorizedForPostCreate() throws Exception {
        val author = new Author(1L, "test author");
        val genre = new Genre(1L, "test genre");
        given(authorService.getAuthorById(1L)).willReturn(author);
        given(genreService.getGenreById(1L)).willReturn(genre);
    ...
    @Test
    @DisplayName(" should redirect to login page when unauthorized for POST /book/delete/{id}")
    void shouldRedirectToLoginPageWhenUnauthorizedForPostDelete() throws Exception{
        mvc.perform(post("/book/delete/1"))
                .andExpect(status().is3xxRedirection());
        verify(bookService, times(0)).deleteBookById(1L);
    }
}