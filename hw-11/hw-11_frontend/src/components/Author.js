...
export class Author extends Component {
    ...
    handleClick = (event) => {
        ...
        const chosenAuthor = authors.find(author => author.id === event.target.dataset.authorId)
        ...
        return (
            <div>
                            ...
                            <tr key={author.id}>
                                ...
                                <td>
                                    <button name="delete" onClick={this.handleClick} type="button"
                                            ...
                                            data-bs-toggle="modal" data-author-id={author.id}
                ...
                <DeleteModal
                    ...
                    entityId={this.state.chosenAuthor.id}
